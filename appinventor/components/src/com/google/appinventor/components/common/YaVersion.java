...
public class YaVersion {
  ...
  public static final String PREFERRED_COMPANION = "2.48t1";
  ...
  public static final String COMPANION_UPDATE_EMULATOR_URL = "CompanionUpgradeHelper.asc";
  public static final String [] ACCEPTABLE_COMPANIONS = { "2.48t1" };
