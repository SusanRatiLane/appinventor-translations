...
//          context.hardreset(context.formName); // kill adb and emulator
        ...
        "checkversionupgrade" : function(fatal, installer, force) {
            ...
            if (installer != "com.android.vending" && window.parent.COMPANION_UPDATE_URL) {
                ...
                dialog = new Blockly.Util.Dialog(Blockly.Msg.REPL_COMPANION_VERSION_CHECK, Blockly.Msg.REPL_COMPANION_OUT_OF_DATE1 + window.parent.PREFERRED_COMPANION + Blockly.Msg.REPL_COMPANION_OUT_OF_DATE2, Blockly.Msg.REPL_OK, null, 0, function() { dialog.hide();});
                engine.resetcompanion();
            } else {
