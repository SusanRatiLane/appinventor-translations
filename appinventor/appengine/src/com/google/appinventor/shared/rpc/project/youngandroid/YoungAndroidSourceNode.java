...
public abstract class YoungAndroidSourceNode extends SourceNode {
  ...
  /**
   * Returns the context name associated with this source node.
   */
  ...
  /**
   * Returns the context name associated with the given fileId.
   * Note that the extension of the fileId is ignored, so this works for both context (.scm) files and
   * blocks (.blk) files.
   */
