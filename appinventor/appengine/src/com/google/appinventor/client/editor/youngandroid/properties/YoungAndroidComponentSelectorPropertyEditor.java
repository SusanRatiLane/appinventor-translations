...
public final class YoungAndroidComponentSelectorPropertyEditor
    extends AdditionalChoicePropertyEditor implements ContextChangeListener {
  // UI elements
  private final ListBox componentsList;

  private final ListWithNone choices;

  // The YaContextEditor associated with this property editor.
   ...
   */
  public YoungAndroidComponentSelectorPropertyEditor(YaContextEditor editor) {
    this(editor, null);
  }
   ...
   */
  public YoungAndroidComponentSelectorPropertyEditor(final YaContextEditor editor,
  ...
  private void finishInitialization() {
    ...
    editor.getContext().addContextChangeListener(this);
  ...
  @Override
  public void orphan() {
    editor.getContext().removeContextChangeListener(this);
    super.orphan();
  }
